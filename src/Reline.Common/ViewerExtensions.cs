...
public static class ViewerExtensions {
	...
	/// <summary>
	/// Calls <see cref="IViewer.Advance"/> and returns the previous element.
	/// </summary>
	...
	public static T AdvanceCurrent<T>(this IViewer<T> viewer) {
	...
	/// <summary>
	/// Calls <see cref="IViewer.Advance"/> while a specified predicate is true.
	/// </summary>
	/// <typeparam name="T">The type of the <see cref="IViewer{T}"/>.</typeparam>
	/// <param name="viewer">The source viewer.</param>
	/// <param name="predicate">The predicate to call on each element.</param>
	public static void AdvanceWhile<T>(this IViewer<T> viewer, Predicate<T> predicate) {
	...
	public static void AdvanceDistance<T>(this IViewer<T> viewer, int distance) {
