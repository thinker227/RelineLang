...
public static class NodeExtensions {
	...
	public static IEnumerable<INode<TNode>> GetDescendants<TNode>(this INode<TNode> node) where TNode : INode<TNode> =>
		node.GetChildren().SelectMany(n => n.GetDescendants().Prepend(n));
