...
public sealed class SymbolTree {
	...
	/// <summary>
	/// Gets a parent node of a specified type of a <see cref="ISymbol"/>.
	/// </summary>
	...
	/// <returns>A <see cref="ISymbol"/> of type <typeparamref name="TParent"/>,
	/// or <see langword="null"/> if none was found.</returns>
	public TParent? GetParentOfType<TParent>(ISymbol node) where TParent : ISymbol =>
